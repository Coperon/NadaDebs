<template>
  <div class="country-selector fixed top-4 right-4 z-50 bg-white border rounded shadow p-2 flex items-center gap-2 w-[300px]">
...
import { getAvailableCountries } from '@/composables/shopify'
