                ...
                <li class="flex flex-col">
                    ...
                    <div class="submenu overflow-hidden transition-all duration-300 ease-in-out" :style="{ maxHeight: activeMenu === 'shop' ? menuHeights.shop + 'px' : '0px' }">
                        <ul class="pt-2 flex flex-col items-center gap-2">
                            ...
                            <li><NuxtLink to="/shop/collections" class="lowercase">Collections</NuxtLink></li>
                        </ul>
                    </div>
                </li>
                <li class="flex flex-col">
                    ...
                    <div class="submenu overflow-hidden transition-all duration-300 ease-in-out" :style="{ maxHeight: activeMenu === 'ourWorld' ? menuHeights.ourWorld + 'px' : '0px' }">
                        <ul class="pt-2 flex flex-col items-center gap-2">
                            ...
                            <li><NuxtLink to="/our-world/crafts" class="lowercase">Contemporary Crafts</NuxtLink></li>
                        </ul>
                    </div>
                </li>
                <li class="flex flex-col">
                    ...
                    <div @mouseenter="toggleMenu('shop'); isBgWhite = true; hoveredMenu = 'shop'" @mouseleave="toggleMenu('ourWorld'); isBgWhite = false; hoveredMenu = null" class="relative">
                        ...
                        <Transition name="fade">
                            <ul v-if="activeMenu === 'shop'" class="absolute top-full left-0 pt-2 flex flex-col items-start text-a2">
                                ...
                                <li><NuxtLink @mouseenter="hoveredSubmenu = 'collections'" @mouseleave="hoveredSubmenu = null" to="/shop/collections" class="lowercase whitespace-nowrap transition-opacity duration-300 py-0.5 flex" :class="{ 'opacity-30': hoveredSubmenu && hoveredSubmenu !== 'collections' }">Collections</NuxtLink></li>
                            </ul>
                        </Transition>
                    </div>
                </li>
                    ...
                    <div @mouseenter="showOurWorldMenu = true; hoveredMenu = 'ourWorld'" @mouseleave="showOurWorldMenu = false; hoveredMenu = null" class="relative">
                        ...
                        <Transition name="fade">
                            <ul v-if="showOurWorldMenu" class="absolute top-full left-1/2 -translate-x-1/2 pt-2 flex flex-col items-center text-center text-a2">
                                ...
                                <li><NuxtLink @mouseenter="hoveredSubmenu = 'crafts'" @mouseleave="hoveredSubmenu = null" to="/our-world/crafts" class="lowercase whitespace-nowrap transition-opacity duration-300 py-0.5 flex" :class="{ 'opacity-30': hoveredSubmenu && hoveredSubmenu !== 'crafts' }">Contemporary Crafts</NuxtLink></li>
                            </ul>
                        </Transition>
                    </div>
                </li>
