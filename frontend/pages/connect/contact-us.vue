            ...
            <div class="px-4 sm:px-6 lg:px-8 xl:px-12 max-w-screen-sm mx-auto md:w-1/2">
                <form>
                    <div class="grid grid-cols-1 gap-3">
                        <CommonFormInput type="text" placeholder="First Name *" required />
                        <CommonFormInput type="text" placeholder="Last Name *" required />
                        <CommonFormInput type="tel" placeholder="Mobile Number *" required />
                        <CommonFormInput type="email" placeholder="Email Address *" required />
                        <CommonFormInput type="text" placeholder="Country *" required />
                        <CommonFormInput type="text" placeholder="Profession *" required />
                        <CommonFormTextarea placeholder="Message *" required />
                    </div>
                    <div class="mt-6 flex items-center gap-2">
                        ...
                        <label for="terms" class="text-a2">I have read and agreed to Nada Debs <NuxtLink to="" class="underline">Terms & Conditions</NuxtLink> and <NuxtLink to="" class="underline">Privacy Policy</NuxtLink></label>
                    </div>
